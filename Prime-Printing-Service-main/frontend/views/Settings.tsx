                                        ...
                                        <div className="grid grid-cols-1 xl:grid-cols-3 gap-10 mb-12">
                                            <div className="bg-white p-6 rounded-lg border border-[#D4D7DC] shadow-sm flex flex-col items-center text-center group hover:border-[#2CA01C] transition-all">
                                                ...
                                                <div className="text-[10px] font-bold uppercase tracking-widest text-slate-400 mb-6">
                                                    Last backup: {backupStatus.lastBackupAt ? new Date(backupStatus.lastBackupAt).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 }) : 'Not yet created'}
                                                </div>
                                            ...
                                            <div className="bg-white p-6 rounded-lg border border-[#D4D7DC] shadow-sm flex flex-col items-center text-center group hover:border-[#2CA01C] transition-all">
                                                ...
                                                <div className="text-[10px] font-bold uppercase tracking-widest text-slate-400 mb-6">
                                                    Last restore: {backupStatus.lastRestoreAt ? `${new Date(backupStatus.lastRestoreAt).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}${backupStatus.lastRestoreFile ? ` â€¢ ${backupStatus.lastRestoreFile}` : ''}` : 'No restore executed'}
                                                </div>
                                                <button
